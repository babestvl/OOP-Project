...
public class ShoppingCustomerDrink extends JPanel {
	 ...
	 * Create the panel.
	 */
	public ShoppingCustomerDrink(Restaurant res) {
		this.res = res;
		...
		JLabel background = new JLabel(
				new ImageIcon(this.getClass().getClassLoader().getResource("shopping/ShoppingBGDrink.jpg")));
